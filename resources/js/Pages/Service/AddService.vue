...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Добавление услуги</h2>
        </template>

        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <form @submit.prevent="form.post(route('store-service'))" class="mt-6 space-y-6">
            <div>
            ...
            <div>
                <InputLabel for="about" value="Описание" />
            ...
            <div>
                <InputLabel for="min_price" value="Минимальная цена" />
